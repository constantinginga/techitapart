    ...
    implements LocalModel, LocalListener<String, Integer>
{
  ...
  @Override public ArrayList<String> getAllCategory() throws RemoteException
  {
  ...
  @Override public void uploadImage(File file, String url)
  {
    try
    {
  ...
  @Override public void buy(String username) throws RemoteException
  {
    client.buy(username);
  }
  ...
  @Override public void addOrder() throws RemoteException
  {
    client.addOrder();
  }
  ...
  @Override public boolean addListener(GeneralListener<String, Integer> listener,
      String... propertyNames)
  {
    return property.addListener(listener, propertyNames);
  }

  @Override public boolean removeListener(GeneralListener<String, Integer> listener,
      String... propertyNames)
  {
