...
public class LoginViewController extends ViewController{
    ...
    @FXML private void handleSLoginButton(ActionEvent actionEvent) throws IOException {
    ...
    @FXML private void handleBackButton(ActionEvent actionEvent) throws IOException {
        super.getViewHandler().openView("EntryView.fxml");
    }

    @FXML private void handleHyperLink(ActionEvent actionEvent) throws IOException {
